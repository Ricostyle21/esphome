...
static const uint8_t LUT_SIZE_1IN54V2 = 159;

static const uint8_t PARTIAL_UPDATE_LUT_1IN54V2[LUT_SIZE_1IN54V2] =
{
...
static const uint8_t FULL_UPDATE_LUT_1IN54V2[LUT_SIZE_1IN54V2] =
{
...
void WaveshareEPaperTypeA::initialize() {
  if ((this->model_ == TTGO_EPAPER_2_13_IN_B74) || (this->model_ == WAVESHARE_EPAPER_1_54_IN_V2))  {
    ...
    if (full_update != prev_full_update) {
      switch (this->model_) {
        ...
        case WAVESHARE_EPAPER_1_54_IN_V2:
          ...
          if (full_update) {
            this->initialize();
            this->write_lut_(FULL_UPDATE_LUT_1IN54V2, 153);
            this->command(0x3f);
            this->data(FULL_UPDATE_LUT_1IN54V2[153]);
            this->command(0x03);	// gate voltage
            this->data(FULL_UPDATE_LUT_1IN54V2[154]);
            this->command(0x04);	// source voltage
            this->data(FULL_UPDATE_LUT_1IN54V2[155]);	// VSH
            this->data(FULL_UPDATE_LUT_1IN54V2[156]);	// VSH2
            this->data(FULL_UPDATE_LUT_1IN54V2[157]);	// VSL
            this->command(0x2c);		// VCOM
            this->data(FULL_UPDATE_LUT_1IN54V2[158]);
          } else {
            this->write_lut_(PARTIAL_UPDATE_LUT_1IN54V2, 153);
            this->command(0x3f);
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[153]);
            this->command(0x03);	// gate voltage
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[154]);
            this->command(0x04);	// source voltage
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[155]);	// VSH
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[156]);	// VSH2
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[157]);	// VSL
            this->command(0x2c);		// VCOM
            this->data(PARTIAL_UPDATE_LUT_1IN54V2[158]);
          }
          this->wait_until_idle_();
          break;
        default:
